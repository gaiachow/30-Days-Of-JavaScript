...
3. Write a multi‑line comment which says, _comments can make code readable, easy to reuse, and informative_.
...
10. Declare two variables _myAge_ and _yourAge_, assign them initial values, and log them to the browser console.
